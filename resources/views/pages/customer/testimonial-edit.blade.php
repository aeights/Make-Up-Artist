...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <form action="{{ route('cust.update.testimonial') }}" method="POST">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Write your testimonial here">{{ $testimonial->description }}</textarea>
                    </div>
